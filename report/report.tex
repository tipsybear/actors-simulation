...
\begin{figure*}[!t]
    \centering
    \subfloat[Email Dataflow]{\includegraphics[width=0.3\textwidth]{balance_sim_queue_lag_ten}
    \label{fig:dataflow_utilization}}
    \hfil
    \subfloat[Online Recommendation]{\includegraphics[width=0.3\textwidth]{balance_sim_queue_lag_zero}
    \label{fig:nnmf_utilization}}
    \hfil
    \subfloat[Solar Prediction]{\includegraphics[width=0.3\textwidth]{balance_sim_unbounded_growth}
